...
public class APISearchActivity extends Activity {
    ...
    public static final String TITLE_MESSAGE = "com.mobile_computing.APISearchActivity.TITLE_MESSAGE";
    public static final String TEXT_MESSAGE = "com.mobile_computing.APISearchActivity.TEXT_MESSAGE";
    public static final String IMAGE_MESSAGE = "com.mobile_computing.APISearchActivity.IMAGE_MESSAGE";
    public static final String DATE_MESSAGE = "com.mobile_computing.APISearchActivity.DATE_MESSAGE";
...
//
//                toast.show();
                Intent intent = new Intent(APISearchActivity.this,TestActivity.class);
